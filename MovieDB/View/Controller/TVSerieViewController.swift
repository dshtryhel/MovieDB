...
final class TVSerieViewController: UIViewController {
    
    @IBOutlet private weak var scrollView: UIScrollView!
    @IBOutlet private weak var topRatedTVSerieCollectionView: UICollectionView!
    @IBOutlet private weak var popularTVSerieTableView: UITableView!
    
    @IBOutlet private weak var popularTVSerieTableViewHeightAnchor: NSLayoutConstraint!
    @IBOutlet private weak var topRatedTVSerieSpinner: UIActivityIndicatorView!
    @IBOutlet private weak var popularTVSerieSpinner: UIActivityIndicatorView!
